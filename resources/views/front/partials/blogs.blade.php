    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-6 col-12 mb-md-0 mb-4 text-center">
                <div class="blog-section-plan-box">
                    ...
                    <a class="text-decoration-none" href="single-post.html">
                        <h4 class="font-weight-bold">Top Call Deflection Strategies for the Contact Center</h4>
                    </a>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-12 mb-md-0 mb-4 text-center">
                <div class="blog-section-plan-box">
                    <figure>
                        <img class="img-fluid" src="{{ asset('/assets/images/blog-post-img-2.png') }}" alt="">
                    </figure>
                    <ul class="blog-plan-box-listing p-0">
                        <li class="list-unstyled d-inline-block"><a class="d-inline-block text-decoration-none meta"
                                                                    href="#">Admin -</a></li>
                        <li class="list-unstyled d-inline-block"><a class="d-inline-block text-decoration-none meta"
                                                                    href="#">March 28, 2022</a></li>
                        <li class="list-unstyled d-inline-block"><a class="d-inline-block text-decoration-none meta"
                                                                    href="#">- News</a></li>
                    </ul>
                    <a class="text-decoration-none" href="single-post.html">
                        <h4 class="font-weight-bold">Maintain a Helpful and Positive Attitude</h4>
                    </a>
                    <a class="read-more d-inline-block text-decoration-none" href="single-post.html">Read More
                        <i class="far fa-long-arrow-alt-right position-relative"></i>
                    </a>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-12 text-center">
                <div class="blog-section-plan-box">
                    <figure>
                        <img class="img-fluid" src="{{ asset('/assets/images/blog-post-img-3.png') }}" alt="">
                    </figure>
                    <ul class="blog-plan-box-listing p-0">
                        <li class="list-unstyled d-inline-block">
                            <a class="d-inline-block text-decoration-none meta" href="#">Admin -</a>
                        ...
                        <li class="list-unstyled d-inline-block">
                            <a class="d-inline-block text-decoration-none meta" href="#">September 25, 2022</a>
                        </li>
                        <li class="list-unstyled d-inline-block">
                            <a class="d-inline-block text-decoration-none meta" href="#">- News</a>
                        </li>
                    ...
                    <a class="text-decoration-none" href="single-post.html">
                        <h4 class="font-weight-bold">A Challenge and Opportunity for Customer Service</h4>
                    </a>
                    <a class="read-more d-inline-block text-decoration-none" href="single-post.html">Read More
                        <i class="far fa-long-arrow-alt-right position-relative"></i>
                    </a>
