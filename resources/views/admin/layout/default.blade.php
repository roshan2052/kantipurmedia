        ...
        <div class="modal-dialog modal-dialog-centered  modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ __('Permissions') }}</h5>
    ...
    <div class="modal fade" id="ImportDataForm">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                @csrf
                    <div class="modal-header">
                        <h5 class="modal-title">{{ __('Import Demo Data') }}</h5>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="draft">{{ __('Draft all existing pages, I will manage one by one.') }}</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="import_type" value="delete" id="delete">
                                        <label class="form-check-label" for="delete">{{ __('Delete all existing data and setup new theme.') }}</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="import_type" value="only_import" id="only_import" checked>
                                        <label class="form-check-label" for="only_import">{{ __('Import data and setup new theme without draft and deleting data.') }}</label>
                                    </div>
                                </div>
                            </div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" id="importBtn">{{ __('Save changes') }}</button>
                    </div>
                </form>
            </div>
        </div>
